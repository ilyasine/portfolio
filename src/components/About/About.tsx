    ...
    <Container id="sobre">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.4 * 1000} style={{marginTop: "2rem"}}>
          <p>WordPress is not only my daily business but my passion. I engage myself in the open-source community through support, free Plugins and sharing knowledge.</p>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.8 * 1000}>
          ...
          <p>I make it possible ( and I love ) to create highly individual, customized and state-of-the-art wordpress solutions tailored to your needs.</p>
        </ScrollAnimation>
